...
fun TimePickerDialog(
    sadhanaItemId: SadhanaItemId? = null,
    onCancel: () -> Unit,
    ...
    when (sadhanaItemId) {
        ...
        else -> time.timeInMillis = System.currentTimeMillis()
    }
...
private fun DisplayModeToggleButton(
    ...
    when (displayMode) {
        DisplayMode.Picker -> IconButton(
            ...
            Icon(
                painter = painterResource(id = R.drawable.sadhana_ic_keyboard),
                contentDescription = "",
            )
        }
        ...
        DisplayMode.Input -> IconButton(
            ...
            Icon(
                painter = painterResource(id = R.drawable.sadhana_ic_schedule),
                contentDescription = "",
            )
        }
    }
